$(document).ready(function(){
  ...
  $(".allmenu .submenu ul").hover(function(){
  ...
  function bannerAuto(){
		...
		$(".ban ul").stop().animate({marginLeft:"-=370px"},1000,function(){
    ...
    $(".ban ul").stop().animate({marginLeft:"-=370px"},500,function(){
      $(".ban ul li:first-child").appendTo(".ban ul");
      $(this).css({marginLeft:"0px"});
    });
  ...
  $(".ban_btn .ban_left").click(function(){
    ...
    $(".ban ul").stop(true,true).animate({marginLeft:"+=370px"},500,function(){
